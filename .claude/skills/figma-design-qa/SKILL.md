...
description: Audit a Figma file or frame for components and styles that bypass the design system. Flags raw shapes that should be tek components and hardcoded values that should reference Figma Variables. Outputs a clean shareable Markdown report.
---
