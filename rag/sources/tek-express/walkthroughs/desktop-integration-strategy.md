...
- The Tek Design System's existing Qt translation layer (`qt/TekTokens.h`, `tek.dark.qss`, `tek.light.qss`) is the closest existing precedent: [`rag/sources/tek-design-system/code/<latest>/qt.md`](../../../tek-design-system/index.md).
