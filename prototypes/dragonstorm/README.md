...
- **Screen stepper** (left of the screen in landscape, top row in portrait): bezel-plastic up/down buttons (44pt tap targets) around a pressed-in label chip showing the current screen's short name and position (e.g. "Trend · 6 / 13"); wraps at both ends. The BEZEL & FILTER toggle shares the same off-white plastic styling.
