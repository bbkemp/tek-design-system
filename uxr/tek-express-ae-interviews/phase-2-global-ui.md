...
- **Mode state (compliance vs. user-defined) is invisible today** — one dismissable popup, then "for 45 minutes… you will only know that in the report." Cost: "Oh, crap, I just spent two days just not realizing that it's not compliant" (**Dallas/Jesse**); "constant confusion… make it painfully clear" (**Gary**, Will's session). → [ae-dallas-jesse-compliance-mode-and-test-selection](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-compliance-mode-and-test-selection.md), [ae-will-teverovsky-test-selection-and-contextual-help](../../corpus/sources/tek-express/walkthroughs/ae-will-teverovsky-test-selection-and-contextual-help.md)
...
- **Color-coded frame per mode** as reinforcement. **Dallas/Jesse** → [ae-dallas-jesse-compliance-mode-and-test-selection](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-compliance-mode-and-test-selection.md)
...
- **Defined Pause semantics + step rewind + breakpoints** (concept liked, behavior undefined); mid-run config edits ride the MVVM re-architecture ("run 5, fix the 7th, continue"). **Dallas/Jesse** → [ae-dallas-jesse-instruments-sessions-results-debug](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-instruments-sessions-results-debug.md)
...
- **Session-recall warnings must be actionable** — today: "Contact your Tektronix local representative." **Dallas/Jesse** → [ae-dallas-jesse-instruments-sessions-results-debug](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-instruments-sessions-results-debug.md)
...
- **User-editable equipment allowlist** — hard-coded model numbers break automation on B-revisions; "we wait three to six months for software updates so we can use an instrument that we came out with." **Dallas/Jesse** → [ae-dallas-jesse-instruments-sessions-results-debug](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-instruments-sessions-results-debug.md)
- **Bandwidth/probe lockouts become warnings in user-defined mode** (blockers only in compliance). **Dallas/Jesse** → same chunk.
- **VISA detection bug workaround is tribal knowledge** — "Nine times out of 10, when I just do it from here, it doesn't show up." **Dallas/Jesse** → same chunk.
...
- **X: drive retired** — "a hangover from NI TestStand, which has no rationale or requirement for anything we're doing now"; normal save-anywhere (remote/automation use case). **Dallas/Jesse** → [ae-dallas-jesse-setup-flow-friction](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-setup-flow-friction.md)
...
- **Session recall must be correct** — "It doesn't recall the parameters correctly. It just — it's broken." **Dallas/Jesse** → [ae-dallas-jesse-instruments-sessions-results-debug](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-instruments-sessions-results-debug.md)
...
- "They'll fix something in one and break something in the other one." **Dallas/Jesse** → [ae-dallas-jesse-session-context-and-overall-reactions](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-session-context-and-overall-reactions.md)
...
- This is the design system's argument: the shell (and its tokens/components) is owned once, inherited everywhere. Column add/remove everywhere + TekScope's results-table configure as the shared table pattern (team-endorsed). **Dallas/Jesse** → [ae-dallas-jesse-instruments-sessions-results-debug](../../corpus/sources/tek-express/walkthroughs/ae-dallas-jesse-instruments-sessions-results-debug.md)
